...
import com.RemindMe.multispinner.MultiSpinnerSearch;
                ...
                builder.setCancelable(true)
                        .setPositiveButton("Submit", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ...
                                else if(Integer.valueOf(dialog_age.getText().toString())<5 || Integer.valueOf(dialog_age.getText().toString())>90)
                                {
                                    Toast.makeText(Activity_AddPlan.this, "Age should be between 5 year to 90 year", Toast.LENGTH_SHORT).show();
                                }
                                else {
